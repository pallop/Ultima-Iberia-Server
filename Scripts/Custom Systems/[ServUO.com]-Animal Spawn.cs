...
namespace Server
{
  public class AnimalSpawnGenerator
  {
    ...
    public static void Generate()
    {
      ...
      World.Broadcast( 0x35, true, "Animal spawner generation complete. {0}", FeluccaCount );
    }
        ...
        foreach ( Item item in itemList )
        {
            if ( item is XmlSpawner ) {
                ...
                if ( spawner.SpawnObjects.Length > 0 ) {
                    if ( spawner.SpawnObjects[0].TypeName.ToUpper() == "WildFawn" ) {
                    ...
                    else if ( spawner.SpawnObjects[0].TypeName.ToUpper() == "WildHorse" ) {
                        AnimalSpawner.Add(item);
                    }
                    else if ( spawner.SpawnObjects[0].TypeName.ToUpper() == "FarmPig" ) {
                        AnimalSpawner.Add(item);
                    }
                    else if ( spawner.SpawnObjects[0].TypeName.ToUpper() == "GiantRat" ) {
                        AnimalSpawner.Add(item);
                    }
                    ...
                    else if ( spawner.SpawnObjects[0].TypeName.ToUpper() == "TownCat" ) {
                        AnimalSpawner.Add(item);
                    }
                    else if ( spawner.SpawnObjects[0].TypeName.ToUpper() == "Eagle" ) {
                        AnimalSpawner.Add(item);
