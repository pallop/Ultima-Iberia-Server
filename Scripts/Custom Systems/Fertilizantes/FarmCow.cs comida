...
namespace Server.Mobiles
{
    ...
    public class FarmCow : BaseCreature
    {
        ...
        public class InternalTimer : Timer
        {
            ...
            {
                if (cow.Map != null && cow.Map != Map.Internal)
                {
                    object dung = new DungPile();
                    DungPile spawn = (DungPile)Activator.CreateInstance(dung.GetType());
                    spawn.Map = cow.Map;
                    spawn.Location = cow.Location;
                }
            }
        }
