...
{
    public class ElvenSleeper_E : BaseAddon, IChopable
    {
        public override BaseAddonDeed Deed { get { return new ElvenSleeper_EDeed(); } }

        private ElvenSleeper_E m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public ElvenSleeper_E Sleeper { get { return m_Sleeper; } set { } }
        ...
        public ElvenSleeper_E()
        {
            ...
            AddComponent(new ElvenSleeper_EPiece(this, 0x304D), 0, 0, 0);
            AddComponent(new ElvenSleeper_EPiece(this, 0x304C), 1, 0, 0);
        ...
        public ElvenSleeper_E(Serial serial)
            : base(serial)
        {
        }
    ...
    public class ElvenSleeper_EDeed : BaseAddonDeed
    {
        public override BaseAddon Addon { get { return new ElvenSleeper_E(); } }

        [Constructable]
        public ElvenSleeper_EDeed()
        {
            Name = "Elven Sleeper Deed East";
        }

        public ElvenSleeper_EDeed(Serial serial)
            : base(serial)
        {
        }
    ...
    public class ElvenSleeper_EPiece : AddonComponent
    {

        private ElvenSleeper_E m_Sleeper;

        public ElvenSleeper_EPiece(ElvenSleeper_E sleeper, int itemid)
            : base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public ElvenSleeper_EPiece(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (ElvenSleeper_E)reader.ReadItem();
