...
{
    public class TallElvenSleeper_EP : BaseAddon, IChopable
    {
        private TallElvenSleeper_EP m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public TallElvenSleeper_EP Sleeper { get { return m_Sleeper; } set { } }
        ...
        public TallElvenSleeper_EP()
        {
            ...
            AddComponent( new TallElvenSleeper_EPPiece( this, 0x3054 ), 0,  0, 0 );
			AddComponent( new TallElvenSleeper_EPPiece( this, 0x3053 ), 1,  0, 0 );
			AddComponent( new TallElvenSleeper_EPPiece( this, 0x3055 ), 2, -1, 0 );
			AddComponent( new TallElvenSleeper_EPPiece( this, 0x3052 ), 2,  0, 0 );
        ...
        public TallElvenSleeper_EP(Serial serial)
            : base(serial)
        {
        }
    ...
    public class TallElvenSleeper_EPPiece : AddonComponent
    {

        private TallElvenSleeper_EP m_Sleeper;

        public TallElvenSleeper_EPPiece(TallElvenSleeper_EP sleeper, int itemid)
            : base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public TallElvenSleeper_EPPiece(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (TallElvenSleeper_EP)reader.ReadItem();
