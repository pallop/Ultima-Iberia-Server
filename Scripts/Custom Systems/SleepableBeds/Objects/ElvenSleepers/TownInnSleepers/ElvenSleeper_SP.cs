...
{
    public class ElvenSleeper_SP : BaseAddon, IChopable
    {
        private ElvenSleeper_SP m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public ElvenSleeper_SP Sleeper { get { return m_Sleeper; } set { } }
        ...
        public ElvenSleeper_SP()
        {
            ...
            AddComponent(new ElvenSleeper_SPPiece(this, 0x3050), 0, 0, 0);
            AddComponent(new ElvenSleeper_SPPiece(this, 0x3051), 0, -1, 0);
        ...
        public ElvenSleeper_SP(Serial serial): base(serial)
        {
        }
    ...
    public class ElvenSleeper_SPPiece : AddonComponent
    {
        private ElvenSleeper_SP m_Sleeper;

        public ElvenSleeper_SPPiece(ElvenSleeper_SP sleeper, int itemid): base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public ElvenSleeper_SPPiece(Serial serial): base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (ElvenSleeper_SP)reader.ReadItem();
        }
    }
}