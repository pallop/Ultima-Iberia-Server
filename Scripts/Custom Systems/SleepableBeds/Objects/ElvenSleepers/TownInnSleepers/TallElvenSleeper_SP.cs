...
{
    public class TallElvenSleeper_SP : BaseAddon, IChopable
    {
        private TallElvenSleeper_SP m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public TallElvenSleeper_SP Sleeper { get { return m_Sleeper; } set { } }
        ...
        public TallElvenSleeper_SP()
        {
            ...
            AddComponent( new TallElvenSleeper_SPPiece( this,0x3058 ),  0,  0, 0 );
			AddComponent( new TallElvenSleeper_SPPiece( this,0x3057 ), -1,  1, 0 );
			AddComponent( new TallElvenSleeper_SPPiece( this,0x3059 ),  0, -1, 0 );
			AddComponent( new TallElvenSleeper_SPPiece( this,0x3056 ),  0,  1, 0 );
        ...
        public TallElvenSleeper_SP(Serial serial)
            : base(serial)
        {
        }
    ...
    public class TallElvenSleeper_SPPiece : AddonComponent
    {

        private TallElvenSleeper_SP m_Sleeper;

        public TallElvenSleeper_SPPiece(TallElvenSleeper_SP sleeper, int itemid): base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public TallElvenSleeper_SPPiece(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (TallElvenSleeper_SP)reader.ReadItem();
