...
{
    public class TallElvenSleeper_S : BaseAddon, IChopable
    {
        public override BaseAddonDeed Deed { get { return new TallElvenSleeper_SDeed(); } }

        private TallElvenSleeper_S m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public TallElvenSleeper_S Sleeper { get { return m_Sleeper; } set { } }
        ...
        public TallElvenSleeper_S()
        {
            ...
            AddComponent( new TallElvenSleeper_SPiece( this,0x3058 ),  0,  0, 0 );
			AddComponent( new TallElvenSleeper_SPiece( this,0x3057 ), -1,  1, 0 );
			AddComponent( new TallElvenSleeper_SPiece( this,0x3059 ),  0, -1, 0 );
			AddComponent( new TallElvenSleeper_SPiece( this,0x3056 ),  0,  1, 0 );
        ...
        public TallElvenSleeper_S(Serial serial): base(serial)
        {
        }
    ...
    public class TallElvenSleeper_SDeed : BaseAddonDeed
    {
        public override BaseAddon Addon { get { return new TallElvenSleeper_S( ); } }

        [Constructable]
        public TallElvenSleeper_SDeed()
        {
            Name = "Tall Elven Sleeper South Deed";
        }

        public TallElvenSleeper_SDeed(Serial serial): base(serial)
        {
        }
    ...
    public class TallElvenSleeper_SPiece : AddonComponent
    {

        private TallElvenSleeper_S m_Sleeper;

        public TallElvenSleeper_SPiece(TallElvenSleeper_S sleeper, int itemid): base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public TallElvenSleeper_SPiece(Serial serial): base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (TallElvenSleeper_S)reader.ReadItem();
