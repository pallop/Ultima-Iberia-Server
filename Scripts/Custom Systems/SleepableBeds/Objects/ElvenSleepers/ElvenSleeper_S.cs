...
{
    public class ElvenSleeper_S : BaseAddon, IChopable
    {
        public override BaseAddonDeed Deed { get { return new ElvenSleeper_SDeed(); } }

        private ElvenSleeper_S m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public ElvenSleeper_S Sleeper { get { return m_Sleeper; } set { } }
        ...
        public ElvenSleeper_S()
        {
            ...
            AddComponent(new ElvenSleeper_SPiece(this, 0x3050), 0, 0, 0);
            AddComponent(new ElvenSleeper_SPiece(this, 0x3051), 0, -1, 0);
        ...
        public ElvenSleeper_S(Serial serial): base(serial)
        {
        }
    ...
    public class ElvenSleeper_SDeed : BaseAddonDeed
    {
        public override BaseAddon Addon { get { return new ElvenSleeper_S( ); } }

        [Constructable]
        public ElvenSleeper_SDeed()
        {
            Name = "Elven Sleeper Deed South";
        }

        public ElvenSleeper_SDeed(Serial serial): base(serial)
        {
        }
    ...
    public class ElvenSleeper_SPiece : AddonComponent
    {

        private ElvenSleeper_S m_Sleeper;

        public ElvenSleeper_SPiece(ElvenSleeper_S sleeper, int itemid): base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public ElvenSleeper_SPiece(Serial serial): base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (ElvenSleeper_S)reader.ReadItem();
