...
{
    public class FurSleeper_S : BaseAddon, IChopable
    {
        public override BaseAddonDeed Deed { get { return new FurSleeper_SDeed(); } }

        private FurSleeper_S m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public FurSleeper_S Sleeper { get { return m_Sleeper; } set { } }
        ...
        public FurSleeper_S()
        {
            ...
            AddComponent( new FurSleeper_SPiece(this, 4602), 0, 0, 0 );
        ...
        public FurSleeper_S(Serial serial): base(serial)
        {
        }
    ...
    public class FurSleeper_SDeed : BaseAddonDeed
    {
        public override BaseAddon Addon { get { return new FurSleeper_S( ); } }

        [Constructable]
        public FurSleeper_SDeed()
        {
            Name = "Fur Sleeper Deed South";
        }

        public FurSleeper_SDeed(Serial serial): base(serial)
        {
        }
    ...
    public class FurSleeper_SPiece : AddonComponent
    {

        private FurSleeper_S m_Sleeper;

        public FurSleeper_SPiece(FurSleeper_S sleeper, int itemid): base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public FurSleeper_SPiece(Serial serial): base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (FurSleeper_S)reader.ReadItem();
