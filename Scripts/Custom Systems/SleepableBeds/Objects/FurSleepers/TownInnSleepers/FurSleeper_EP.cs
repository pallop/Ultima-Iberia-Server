...
{
    public class FurSleeper_EP : BaseAddon, IChopable
    {
        private FurSleeper_EP m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public FurSleeper_EP Sleeper { get { return m_Sleeper; } set { } }
        ...
        public FurSleeper_EP()
        {
            ...
            AddComponent( new FurSleeper_EPPiece(this, 4599), 0, 0, 0 );
        ...
        public FurSleeper_EP(Serial serial)
            : base(serial)
        {
        }
    ...
    public class FurSleeper_EPPiece : AddonComponent
    {

        private FurSleeper_EP m_Sleeper;

        public FurSleeper_EPPiece(FurSleeper_EP sleeper, int itemid)
            : base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public FurSleeper_EPPiece(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (FurSleeper_EP)reader.ReadItem();
