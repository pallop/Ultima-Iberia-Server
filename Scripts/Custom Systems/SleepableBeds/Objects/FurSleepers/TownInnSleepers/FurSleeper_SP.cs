...
{
    public class FurSleeper_SP : BaseAddon, IChopable
    {
        private FurSleeper_SP m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public FurSleeper_SP Sleeper { get { return m_Sleeper; } set { } }
        ...
        public FurSleeper_SP()
        {
            ...
            AddComponent( new FurSleeper_SPPiece(this, 4602), 0, 0, 0 );
        ...
        public FurSleeper_SP(Serial serial)
            : base(serial)
        {
        }
    ...
    public class FurSleeper_SPPiece : AddonComponent
    {

        private FurSleeper_SP m_Sleeper;

        public FurSleeper_SPPiece(FurSleeper_SP sleeper, int itemid): base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public FurSleeper_SPPiece(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (FurSleeper_SP)reader.ReadItem();
