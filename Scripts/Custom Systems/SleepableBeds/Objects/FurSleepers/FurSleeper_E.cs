...
{
    public class FurSleeper_E : BaseAddon, IChopable
    {
        public override BaseAddonDeed Deed { get { return new FurSleeper_EDeed(); } }

        private FurSleeper_E m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public FurSleeper_E Sleeper { get { return m_Sleeper; } set { } }
        ...
        public FurSleeper_E()
        {
            ...
            AddComponent( new FurSleeper_EPiece(this, 4599), 0, 0, 0 );
        ...
        public FurSleeper_E(Serial serial)
            : base(serial)
        {
        }
    ...
    public class FurSleeper_EDeed : BaseAddonDeed
    {
        public override BaseAddon Addon { get { return new FurSleeper_E(); } }

        [Constructable]
        public FurSleeper_EDeed()
        {
            Name = "Fur Sleeper Deed East";
        }

        public FurSleeper_EDeed(Serial serial)
            : base(serial)
        {
        }
    ...
    public class FurSleeper_EPiece : AddonComponent
    {

        private FurSleeper_E m_Sleeper;

        public FurSleeper_EPiece(FurSleeper_E sleeper, int itemid)
            : base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public FurSleeper_EPiece(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (FurSleeper_E)reader.ReadItem();
