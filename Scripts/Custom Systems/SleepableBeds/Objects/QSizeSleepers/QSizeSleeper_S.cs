...
{
    public class QSizeSleeper_S : BaseAddon, IChopable
    {
        public override BaseAddonDeed Deed { get { return new QSizeSleeper_SDeed(); } }

        private QSizeSleeper_S m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public QSizeSleeper_S Sleeper { get { return m_Sleeper; } set { } }
        ...
        [Constructable]
        public QSizeSleeper_S()
        {
            Visible = true;
            Name = "Queen Sized Sleeper";

            #region Bed Component Item ID's

            AddComponent( new QSizeSleeper_SPiece(this, 0xA83), 0, 0, 0 );
			AddComponent( new QSizeSleeper_SPiece(this, 0xA7F), 0, 1, 0 );
			AddComponent( new QSizeSleeper_SPiece(this, 0xA82), 1, 0, 0 );
			AddComponent( new QSizeSleeper_SPiece(this, 0xA7E), 1, 1, 0 );
            ...
            else
            {
                if (!m_Sleeping)
                {
                    ...
                    if (m_house != null && (m_house.IsOwner(from) || m_house.IsCoOwner(from) || m_house.IsFriend(from)))
                    {
                        ...
                        Point3D m_Location = new Point3D(this.Location.X, this.Location.Y + 1, this.Location.Z + 3);
        ...
        public QSizeSleeper_S(Serial serial): base(serial)
        {
        }
    ...
    public class QSizeSleeper_SDeed : BaseAddonDeed
    {
        public override BaseAddon Addon { get { return new QSizeSleeper_S( ); } }

        [Constructable]
        public QSizeSleeper_SDeed()
        {
            Name = "Queen Sized Sleeper South Deed";
        }

        public QSizeSleeper_SDeed(Serial serial): base(serial)
        {
        }
    ...
    public class QSizeSleeper_SPiece : AddonComponent
    {

        private QSizeSleeper_S m_Sleeper;

        public QSizeSleeper_SPiece(QSizeSleeper_S sleeper, int itemid): base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public QSizeSleeper_SPiece(Serial serial): base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (QSizeSleeper_S)reader.ReadItem();
