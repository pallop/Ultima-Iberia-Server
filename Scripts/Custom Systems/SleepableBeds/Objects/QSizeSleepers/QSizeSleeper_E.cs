...
{
    public class QSizeSleeper_E : BaseAddon, IChopable
    {
        public override BaseAddonDeed Deed { get { return new QSizeSleeper_EDeed(); } }

        private QSizeSleeper_E m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public QSizeSleeper_E Sleeper { get { return m_Sleeper; } set { } }
        ...
        public QSizeSleeper_E()
        {
            ...
            AddComponent( new QSizeSleeper_EPiece(this, 0xA7D), 0, 0, 0 );
			AddComponent( new QSizeSleeper_EPiece(this, 0xA7C), 0, 1, 0 );
			AddComponent( new QSizeSleeper_EPiece(this, 0xA79), 1, 0, 0 );
			AddComponent( new QSizeSleeper_EPiece(this, 0xA78), 1, 1, 0 );
            ...
            else
            {
                if (!m_Sleeping)
                {
                    ...
                    if (m_house != null && (m_house.IsOwner(from) || m_house.IsCoOwner(from) || m_house.IsFriend(from)))
                    {
                        ...
                        Point3D m_Location = new Point3D(this.Location.X + 2, this.Location.Y + 1, this.Location.Z + 14);
        ...
        public QSizeSleeper_E(Serial serial)
            : base(serial)
        {
        }
    ...
    public class QSizeSleeper_EDeed : BaseAddonDeed
    {
        public override BaseAddon Addon { get { return new QSizeSleeper_E(); } }

        [Constructable]
        public QSizeSleeper_EDeed()
        {
            Name = "Queen Sized Sleeper East Deed";
        }

        public QSizeSleeper_EDeed(Serial serial)
            : base(serial)
        {
        }
    ...
    public class QSizeSleeper_EPiece : AddonComponent
    {

        private QSizeSleeper_E m_Sleeper;

        public QSizeSleeper_EPiece(QSizeSleeper_E sleeper, int itemid)
            : base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public QSizeSleeper_EPiece(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (QSizeSleeper_E)reader.ReadItem();
