...
{
    public class QSizeSleeper_SP : BaseAddon, IChopable
    {
        private QSizeSleeper_SP m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public QSizeSleeper_SP Sleeper { get { return m_Sleeper; } set { } }
        ...
        public QSizeSleeper_SP()
        {
            ...
            AddComponent( new QSizeSleeper_SPPiece(this, 0xA83), 0, 0, 0 );
			AddComponent( new QSizeSleeper_SPPiece(this, 0xA7F), 0, 1, 0 );
			AddComponent( new QSizeSleeper_SPPiece(this, 0xA82), 1, 0, 0 );
			AddComponent( new QSizeSleeper_SPPiece(this, 0xA7E), 1, 1, 0 );
        ...
        public QSizeSleeper_SP(Serial serial)
            : base(serial)
        {
        }
    ...
    public class QSizeSleeper_SPPiece : AddonComponent
    {

        private QSizeSleeper_SP m_Sleeper;

        public QSizeSleeper_SPPiece(QSizeSleeper_SP sleeper, int itemid): base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public QSizeSleeper_SPPiece(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (QSizeSleeper_SP)reader.ReadItem();
