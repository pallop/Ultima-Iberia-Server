...
{
    public class QSizeSleeper_EP : BaseAddon, IChopable
    {
        private QSizeSleeper_EP m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public QSizeSleeper_EP Sleeper { get { return m_Sleeper; } set { } }
        ...
        public QSizeSleeper_EP()
        {
            ...
            AddComponent( new QSizeSleeper_EPPiece(this, 0xA7D), 0, 0, 0 );
			AddComponent( new QSizeSleeper_EPPiece(this, 0xA7C), 0, 1, 0 );
			AddComponent( new QSizeSleeper_EPPiece(this, 0xA79), 1, 0, 0 );
			AddComponent( new QSizeSleeper_EPPiece(this, 0xA78), 1, 1, 0 );
        ...
        public QSizeSleeper_EP(Serial serial)
            : base(serial)
        {
        }
    ...
    public class QSizeSleeper_EPPiece : AddonComponent
    {
        private QSizeSleeper_EP m_Sleeper;

        public QSizeSleeper_EPPiece(QSizeSleeper_EP sleeper, int itemid)
            : base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public QSizeSleeper_EPPiece(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (QSizeSleeper_EP)reader.ReadItem();
