...
{
    public class SSizeSleeper_E : BaseAddon, IChopable
    {
        public override BaseAddonDeed Deed { get { return new SSizeSleeper_EDeed(); } }

        private SSizeSleeper_E m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public SSizeSleeper_E Sleeper { get { return m_Sleeper; } set { } }
        ...
        public SSizeSleeper_E()
        {
            ...
            AddComponent( new SSizeSleeper_EPiece(this,   0xA5D ), 0, 0, 0 );
			AddComponent( new SSizeSleeper_EPiece(this,   0xA62 ), 1, 0, 0 );
        ...
        public SSizeSleeper_E(Serial serial)
            : base(serial)
        {
        }
    ...
    public class SSizeSleeper_EDeed : BaseAddonDeed
    {
        public override BaseAddon Addon { get { return new SSizeSleeper_E(); } }

        [Constructable]
        public SSizeSleeper_EDeed()
        {
            Name = "Small Sized Sleeper East Deed";
        }

        public SSizeSleeper_EDeed(Serial serial)
            : base(serial)
        {
        }
    ...
    public class SSizeSleeper_EPiece : AddonComponent
    {

        private SSizeSleeper_E m_Sleeper;

        public SSizeSleeper_EPiece(SSizeSleeper_E sleeper, int itemid)
            : base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public SSizeSleeper_EPiece(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (SSizeSleeper_E)reader.ReadItem();
