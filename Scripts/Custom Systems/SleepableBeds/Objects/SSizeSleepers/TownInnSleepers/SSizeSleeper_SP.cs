...
{
    public class SSizeSleeper_SP : BaseAddon, IChopable
    {
        private SSizeSleeper_SP m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public SSizeSleeper_SP Sleeper { get { return m_Sleeper; } set { } }
        ...
        public SSizeSleeper_SP()
        {
            ...
            AddComponent( new SSizeSleeper_SPPiece(  this,0xA63 ), 0, 0, 0 );
			AddComponent( new SSizeSleeper_SPPiece(  this,0xA5C ), 0, 1, 0 );
        ...
        public SSizeSleeper_SP(Serial serial)
            : base(serial)
        {
        }
    ...
    public class SSizeSleeper_SPPiece : AddonComponent
    {

        private SSizeSleeper_SP m_Sleeper;

        public SSizeSleeper_SPPiece(SSizeSleeper_SP sleeper, int itemid): base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public SSizeSleeper_SPPiece(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (SSizeSleeper_SP)reader.ReadItem();
