...
{
    public class SSizeSleeper_EP : BaseAddon, IChopable
    {
        private SSizeSleeper_EP m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public SSizeSleeper_EP Sleeper { get { return m_Sleeper; } set { } }
        ...
        public SSizeSleeper_EP()
        {
            ...
            AddComponent( new SSizeSleeper_EPPiece(this,   0xA5D ), 0, 0, 0 );
			AddComponent( new SSizeSleeper_EPPiece(this,   0xA62 ), 1, 0, 0 );
        ...
        public SSizeSleeper_EP(Serial serial)
            : base(serial)
        {
        }
    ...
    public class SSizeSleeper_EPPiece : AddonComponent
    {

        private SSizeSleeper_EP m_Sleeper;

        public SSizeSleeper_EPPiece(SSizeSleeper_EP sleeper, int itemid)
            : base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public SSizeSleeper_EPPiece(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (SSizeSleeper_EP)reader.ReadItem();
