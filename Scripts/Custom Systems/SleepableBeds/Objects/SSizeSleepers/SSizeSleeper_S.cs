...
{
    public class SSizeSleeper_S : BaseAddon, IChopable
    {
        public override BaseAddonDeed Deed { get { return new SSizeSleeper_SDeed(); } }

        private SSizeSleeper_S m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public SSizeSleeper_S Sleeper { get { return m_Sleeper; } set { } }
        ...
        [Constructable]
        public SSizeSleeper_S()
        {
            Visible = true;
            Name = "Small Sized Sleeper";

            #region Bed Component Item ID's

            AddComponent( new SSizeSleeper_SPiece(  this,0xA63 ), 0, 0, 0 );
			AddComponent( new SSizeSleeper_SPiece(  this,0xA5C ), 0, 1, 0 );
        ...
        public SSizeSleeper_S(Serial serial): base(serial)
        {
        }
    ...
    public class SSizeSleeper_SDeed : BaseAddonDeed
    {
        public override BaseAddon Addon { get { return new SSizeSleeper_S( ); } }

        [Constructable]
        public SSizeSleeper_SDeed()
        {
            Name = "Small Sized Sleeper South Deed";
        }

        public SSizeSleeper_SDeed(Serial serial): base(serial)
        {
        }
    ...
    public class SSizeSleeper_SPiece : AddonComponent
    {

        private SSizeSleeper_S m_Sleeper;

        public SSizeSleeper_SPiece(SSizeSleeper_S sleeper, int itemid): base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public SSizeSleeper_SPiece(Serial serial): base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (SSizeSleeper_S)reader.ReadItem();
