...
{
    public class FutonSleeper_S : BaseAddon, IChopable
    {
        public override BaseAddonDeed Deed { get { return new FutonSleeper_SDeed(); } }

        private FutonSleeper_S m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public FutonSleeper_S Sleeper { get { return m_Sleeper; } set { } }
        ...
        public FutonSleeper_S()
        {
            ...
            AddComponent(new FutonSleeper_SPiece(this, 10591), 0, 0, 0);
        ...
        public FutonSleeper_S(Serial serial)
            : base(serial)
        {
        }
    ...
    public class FutonSleeper_SDeed : BaseAddonDeed
    {
        public override BaseAddon Addon { get { return new FutonSleeper_S(); } }

        [Constructable]
        public FutonSleeper_SDeed()
        {
            Name = "Futon Sleeper Deed South";
        }

        public FutonSleeper_SDeed(Serial serial)
            : base(serial)
        {
        }
    ...
    public class FutonSleeper_SPiece : AddonComponent
    {

        private FutonSleeper_S m_Sleeper;

        public FutonSleeper_SPiece(FutonSleeper_S sleeper, int itemid)
            : base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public FutonSleeper_SPiece(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (FutonSleeper_S)reader.ReadItem();
