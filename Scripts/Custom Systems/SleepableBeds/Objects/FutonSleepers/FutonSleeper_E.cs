...
{
    public class FutonSleeper_E : BaseAddon, IChopable
    {
        public override BaseAddonDeed Deed { get { return new FutonSleeper_EDeed(); } }

        private FutonSleeper_E m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public FutonSleeper_E Sleeper { get { return m_Sleeper; } set { } }
        ...
        public FutonSleeper_E()
        {
            ...
            AddComponent(new FutonSleeper_EPiece(this, 10590), 0, 0, 0);
        ...
        public FutonSleeper_E(Serial serial)
            : base(serial)
        {
        }
    ...
    public class FutonSleeper_EDeed : BaseAddonDeed
    {
        public override BaseAddon Addon { get { return new FutonSleeper_E(); } }

        [Constructable]
        public FutonSleeper_EDeed()
        {
            Name = "Futon Sleeper Deed East";
        }

        public FutonSleeper_EDeed(Serial serial)
            : base(serial)
        {
        }
    ...
    public class FutonSleeper_EPiece : AddonComponent
    {

        private FutonSleeper_E m_Sleeper;

        public FutonSleeper_EPiece(FutonSleeper_E sleeper, int itemid)
            : base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public FutonSleeper_EPiece(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (FutonSleeper_E)reader.ReadItem();
