...
{
    public class FutonSleeper_SP : BaseAddon, IChopable
    {
        private FutonSleeper_SP m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public FutonSleeper_SP Sleeper { get { return m_Sleeper; } set { } }
        ...
        public FutonSleeper_SP()
        {
            ...
            AddComponent(new FutonSleeper_SPPiece(this, 10591), 0, 0, 0);
        ...
        public FutonSleeper_SP(Serial serial)
            : base(serial)
        {
        }
    ...
    public class FutonSleeper_SPPiece : AddonComponent
    {
        private FutonSleeper_SP m_Sleeper;

        public FutonSleeper_SPPiece(FutonSleeper_SP sleeper, int itemid)
            : base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public FutonSleeper_SPPiece(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (FutonSleeper_SP)reader.ReadItem();
        }
    }
}