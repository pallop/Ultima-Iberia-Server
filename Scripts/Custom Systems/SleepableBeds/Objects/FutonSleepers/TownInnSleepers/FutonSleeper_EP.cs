...
{
    public class FutonSleeper_EP : BaseAddon, IChopable
    {
        private FutonSleeper_EP m_Sleeper;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public FutonSleeper_EP Sleeper { get { return m_Sleeper; } set { } }
        ...
        public FutonSleeper_EP()
        {
            ...
            AddComponent(new FutonSleeper_EPPiece(this, 10590), 0, 0, 0);
        ...
        public void DoubleClick(Mobile from)
        {
            ...
            else
            {
                if (!m_Sleeping)
                {
                    ...
                    Point3D m_Location = new Point3D(this.Location.X + 1, this.Location.Y, this.Location.Z + 9);
        ...
        public FutonSleeper_EP(Serial serial)
            : base(serial)
        {
        }
    ...
    public class FutonSleeper_EPPiece : AddonComponent
    {
        private FutonSleeper_EP m_Sleeper;

        public FutonSleeper_EPPiece(FutonSleeper_EP sleeper, int itemid)
            : base(itemid)
        {
            m_Sleeper = sleeper;
        }
        ...
        public FutonSleeper_EPPiece(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            base.Deserialize(reader);
            int version = reader.ReadInt();
            m_Sleeper = (FutonSleeper_EP)reader.ReadItem();
        }
    }
}