...
namespace Server.Items
{
	...
	{
		private DateTime lastpicked = DateTime.UtcNow;
		...
		public MushroomAddon() : base( Utility.RandomMinMax( 3340, 3348 ) )
		{
			Yield=10;
		...
		public MushroomAddon( int itemid ) : base( itemid )
		{
			Yield=10;
		}
		...
		{
			from.SendMessage( "The mushrooms wither. You must add some more mushroom seeds to the garden." ); 
	...
	{
		public override BaseAddonDeed Deed{ get{ return new MushroomGardenSouthDeed(); } }
		...
		public MushroomGardenSouthAddon( Serial serial ) : base( serial )
		{
		}
	...
	{
		public override BaseAddon Addon{ get{ return new MushroomGardenSouthAddon(); } }
		...
		public MushroomGardenSouthDeed( Serial serial ) : base( serial )
		{
		}
	...
	{
		public override BaseAddonDeed Deed{ get{ return new MushroomGardenEastDeed(); } }
		...
		public MushroomGardenEastAddon( Serial serial ) : base( serial )
		{
		}
	...
	{
		public override BaseAddon Addon{ get{ return new MushroomGardenEastAddon(); } }
		...
		public MushroomGardenEastDeed( Serial serial ) : base( serial )
		{
		}
