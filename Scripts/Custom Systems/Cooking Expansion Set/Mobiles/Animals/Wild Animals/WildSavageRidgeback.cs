...
namespace Server.Mobiles
{
	...
	public class WildSavageRidgeback : BaseAnimal
	{
		[Constructable]
		public WildSavageRidgeback( ) : base( AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			BaseSoundID = 0x3F3;
		...
		public WildSavageRidgeback( Serial serial ) : base( serial )
		{
		}
