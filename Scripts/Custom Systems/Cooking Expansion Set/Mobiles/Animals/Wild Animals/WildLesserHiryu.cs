...
namespace Server.Mobiles
{
	...
	public class WildLesserHiryu : BaseAnimal
	{
		...
		[Constructable]
		public WildLesserHiryu() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Activity = ActivityType.Twilight;
			Eats = EatType.Carnivore;
			Animal = AnimalType.Wild;
		...
		public WildLesserHiryu( Serial serial ) : base( serial )
		{
		}
