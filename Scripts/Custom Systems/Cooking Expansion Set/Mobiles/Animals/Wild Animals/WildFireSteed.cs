...
namespace Server.Mobiles
{
	...
	public class WildFireSteed : BaseAnimal
	{
		[Constructable]
		public WildFireSteed( ) : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a fire steed";
			Body = 0xBE;
			BaseSoundID = 0xA8;
		...
		public WildFireSteed( Serial serial ) : base( serial )
		{
		}
