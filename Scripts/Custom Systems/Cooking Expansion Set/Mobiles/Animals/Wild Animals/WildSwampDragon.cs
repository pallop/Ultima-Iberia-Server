...
namespace Server.Mobiles
{
	...
	public class WildSwampDragon : BaseAnimal
	{
		...
		[Constructable]
		public WildSwampDragon( ) : base( AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			Name = "a swamp dragon";
			Body = 0x31A;
			BaseSoundID = 0x16A;
		...
		public WildSwampDragon( Serial serial ) : base( serial )
		{
		}
