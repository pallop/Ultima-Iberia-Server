...
{
	public class LumberjackCoconut : Item
	{
		private TimedSkillMod skillMod; 

		[Constructable]
		public LumberjackCoconut() : base( 0x1726 )
		{
            this.Weight = 1.0;
            this.DefineMods();
            this.Name = "Lumberjack's Coconut";
		...
		private void SetMods( Mobile m )
		{
			m.AddSkillMod( skillMod );
      		...
      		public LumberjackCoconut( Serial serial ) : base( serial ) 
      		{
			DefineMods();
      		} 
