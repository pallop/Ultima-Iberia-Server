...
namespace Server.Items
{
	public class CottonPlantEast : BaseCrop
	{
		...
		[Constructable]
		public CottonPlantEast () : this ( 0x0C68, 1, 5 )
		{
		}
		
		[Constructable]
		public CottonPlantEast(int ItemID, int MinAgeDelay, int MaxAgeDelay ) : base ( ItemID, MinAgeDelay, MaxAgeDelay )
		{
		...
		public CottonPlantEast( Serial serial ) : base( serial )
		{
		}
