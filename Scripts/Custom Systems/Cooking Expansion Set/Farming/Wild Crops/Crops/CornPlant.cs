...
namespace Server.Items
{
	...
	{
		[Constructable]
		public CornPlant () : this (  0x0C68, 1, 5 )
		{
		}
		
		[Constructable]
		public CornPlant( int ItemID, int MinAgeDelay, int MaxAgeDelay ) : base ( ItemID, MinAgeDelay, MaxAgeDelay )
		{
		...
		public CornPlant( Serial serial ) : base( serial )
		{
		}
