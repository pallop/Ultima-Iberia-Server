...
namespace Server.Items
{
	...
	{
		[Constructable]
		public TurnipPlant () : this ( 0xC68, 1, 5 )
		{
		}
		
		[Constructable]
		public TurnipPlant( int ItemID, int MinAgeDelay, int MaxAgeDelay ) : base ( ItemID, MinAgeDelay, MaxAgeDelay )
		{
		...
		public TurnipPlant( Serial serial ) : base( serial )
		{
		}
