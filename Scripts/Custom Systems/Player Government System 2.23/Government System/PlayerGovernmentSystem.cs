...
namespace Server
{
	public class PlayerGovernmentSystem
	{
		...
		public static int Level1 = 2; // Default 20 12
		public static int Level2 = 3; // Default 40 20
		public static int Level3 = 4; // Default 60 35
		public static int Level4 = 5; // Default 80 45
		public static int Level5 = 6; // Default 100 50
		public static int Level6 = 7; // Default 200 55
		...
		*/
		...
		public static string Title1 = "Aldea";
		public static string Title2 = "Villa Pequeña";
		public static string Title3 = "Villa Grande";
		public static string Title4 = "Pueblo Pequeño";
		public static string Title5 = "Pueblo Mediano";
		public static string Title6 = "Pueblo Grande";
