...
{
	public class EmpalizadaEscaleraWestDeed : CityDeed
	{
		[Constructable]
		public EmpalizadaEscaleraWestDeed() : base( 0x13F9, new Point3D( 0, 5, 0 ) )
		{
			Name = "EmpalizadaEscaleraOeste";
			Type = CivicStrutureType.EmpalizadaEscaleraWest;
		}

		public EmpalizadaEscaleraWestDeed( Serial serial ) : base( serial )
		{
		}
