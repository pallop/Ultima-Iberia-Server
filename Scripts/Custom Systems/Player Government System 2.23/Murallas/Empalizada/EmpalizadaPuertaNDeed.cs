...
{
	public class EmpalizadaPuertaNDeed : CityDeed
	{
		[Constructable]
		public EmpalizadaPuertaNDeed() : base( 0x13F9, new Point3D( 0, 5, 0 ) )
		{
			Name = "Empalizada Puerta Norte";
			Type = CivicStrutureType.EmpalizadaPuertaN;
		}

		public EmpalizadaPuertaNDeed( Serial serial ) : base( serial )
		{
		}
