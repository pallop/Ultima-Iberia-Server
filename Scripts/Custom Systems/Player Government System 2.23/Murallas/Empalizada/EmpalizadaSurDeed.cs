...
{
	public class EmpalizadaSurDeed : CityDeed
	{
		[Constructable]
		public EmpalizadaSurDeed() : base( 0x13F9, new Point3D( 0, 5, 0 ) )
		{
			Name = "EmpalizadaSur";
			Type = CivicStrutureType.EmpalizadaSur;
		}

		public EmpalizadaSurDeed( Serial serial ) : base( serial )
		{
		}
