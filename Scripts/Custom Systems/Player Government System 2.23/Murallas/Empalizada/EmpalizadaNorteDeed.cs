...
{
	public class EmpalizadaNorteDeed : CityDeed
	{
		[Constructable]
		public EmpalizadaNorteDeed() : base( 0x13F9, new Point3D( 0, 5, 0 ) )
		{
			Name = "EmpalizadaNorte";
			Type = CivicStrutureType.EmpalizadaNorte;
		}

		public EmpalizadaNorteDeed( Serial serial ) : base( serial )
		{
		}
