...
{
	public class EmpalizadaEscaleraEstDeed : CityDeed
	{
		[Constructable]
		public EmpalizadaEscaleraEstDeed() : base( 0x13F9, new Point3D( 0, 5, 0 ) )
		{
			Name = "EmpalizadaEscaleraEste";
			Type = CivicStrutureType.EmpalizadaEscaleraEst;
		}

		public EmpalizadaEscaleraEstDeed( Serial serial ) : base( serial )
		{
		}
