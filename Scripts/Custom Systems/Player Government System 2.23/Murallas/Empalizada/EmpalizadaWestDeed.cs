...
{
	public class EmpalizadaWestDeed : CityDeed
	{
		[Constructable]
		public EmpalizadaWestDeed() : base( 0x13F9, new Point3D( 0, 5, 0 ) )
		{
			Name = "EmpalizadaOeste";
			Type = CivicStrutureType.EmpalizadaWest;
		}

		public EmpalizadaWestDeed( Serial serial ) : base( serial )
		{
		}
