...
{
	public class EmpalizadaEscaleraNorteDeed : CityDeed
	{
		[Constructable]
		public EmpalizadaEscaleraNorteDeed() : base( 0x13F9, new Point3D( 0, 5, 0 ) )
		{
			Name = "EmpalizadaEscaleraNorte";
			Type = CivicStrutureType.EmpalizadaEscaleraNorte;
		}

		public EmpalizadaEscaleraNorteDeed( Serial serial ) : base( serial )
		{
		}
