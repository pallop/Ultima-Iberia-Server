...
{
	public class EmpalizadaEscaleraSurDeed : CityDeed
	{
		[Constructable]
		public EmpalizadaEscaleraSurDeed() : base( 0x13F9, new Point3D( 0, 5, 0 ) )
		{
			Name = "EmpalizadaEscaleraSur";
			Type = CivicStrutureType.EmpalizadaEscaleraSur;
		}

		public EmpalizadaEscaleraSurDeed( Serial serial ) : base( serial )
		{
		}
