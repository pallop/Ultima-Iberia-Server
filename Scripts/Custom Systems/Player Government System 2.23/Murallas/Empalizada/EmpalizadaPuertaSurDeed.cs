...
{
	public class EmpalizadaPuertaSurDeed : CityDeed
	{
		[Constructable]
		public EmpalizadaPuertaSurDeed() : base( 0x13F9, new Point3D( 0, 5, 0 ) )
		{
			Name = "Empalizada Puerta Sur";
			Type = CivicStrutureType.EmpalizadaPuertaSur;
		}

		public EmpalizadaPuertaSurDeed( Serial serial ) : base( serial )
		{
		}
