...
{
	public class EmpalizadaPuertaEstDeed : CityDeed
	{
		[Constructable]
		public EmpalizadaPuertaEstDeed() : base( 0x13F9, new Point3D( 0, 5, 0 ) )
		{
			Name = "Empalizada Puerta Este";
			Type = CivicStrutureType.EmpalizadaPuertaEst;
		}

		public EmpalizadaPuertaEstDeed( Serial serial ) : base( serial )
		{
		}
