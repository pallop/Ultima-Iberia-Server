...
{
	public class EmpalizadaTorreEsquineraDeed : CityDeed
	{
		[Constructable]
		public EmpalizadaTorreEsquineraDeed() : base( 0x13F9, new Point3D( 0, 5, 0 ) )
		{
			Name = "Empalizada Torre Esquinera";
			Type = CivicStrutureType.EmpalizadaTorreEsquinera;
		}

		public EmpalizadaTorreEsquineraDeed( Serial serial ) : base( serial )
		{
		}
