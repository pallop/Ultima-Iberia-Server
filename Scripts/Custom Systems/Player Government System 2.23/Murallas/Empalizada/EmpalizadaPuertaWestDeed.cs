...
{
	public class EmpalizadaPuertaWestDeed : CityDeed
	{
		[Constructable]
		public EmpalizadaPuertaWestDeed() : base( 0x13F9, new Point3D( 0, 5, 0 ) )
		{
			Name = "Empalizada Puerta Oeste";
			Type = CivicStrutureType.EmpalizadaPuertaWest;
		}

		public EmpalizadaPuertaWestDeed( Serial serial ) : base( serial )
		{
		}
