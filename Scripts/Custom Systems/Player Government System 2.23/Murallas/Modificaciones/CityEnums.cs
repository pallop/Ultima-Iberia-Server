	...
	public enum CivicStrutureType
	{
		...
		*/
		...
		PlasterMarket,
                ...
                //murallas
EmpalizadaEscaleraNorte,
EmpalizadaNorte,
EmpalizadaPuertaN,
EmpalizadaTorreEsquinera,
EmpalizadaEscaleraWest,
EmpalizadaWest,
EmpalizadaEscaleraEst,
EmpalizadaEst,
EmpalizadaEscaleraSur,
EmpalizadaSur,
EmpalizadaPuertaEst,
EmpalizadaPuertaWest,
EmpalizadaPuertaSur,
	...
	public class CityTypes
	{
		public static Type[] Types = new Type[]
		{
			...
			typeof(BarracksAddon),
			//murallas
			typeof(EmpalizadaEscaleraNorteAddon),
			typeof(EmpalizadaNorteAddon),
			typeof(EmpalizadaPuertaNAddon),
			typeof(EmpalizadaTorreEsquineraAddon),
			typeof(EmpalizadaEscaleraWestAddon),
			typeof(EmpalizadaWestAddon),
			typeof(EmpalizadaEscaleraEstAddon),
			typeof(EmpalizadaEstAddon),
			typeof(EmpalizadaEscaleraSurAddon),
			typeof(EmpalizadaSurAddon),
			typeof(EmpalizadaPuertaEstAddon),
		    typeof(EmpalizadaPuertaWestAddon),
		    typeof(EmpalizadaPuertaSurAddon),
