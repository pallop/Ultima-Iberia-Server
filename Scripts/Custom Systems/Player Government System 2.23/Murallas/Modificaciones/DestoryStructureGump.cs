			...
			if ( from == null )
				...
				foreach ( Item item in m_Sign.toDelete )
				{
					...
					else if ( item is LargeCityParkAddon )
					{
						from.AddToBackpack( new LargeCityParkDeed() );
                                        ...
                                        else if ( item is BarracksAddon )
					{
						from.AddToBackpack( new BarracksAddonDeed() );
					}
					//Murallas
					else if ( item is EmpalizadaEscaleraNorteAddon )
					{
						from.AddToBackpack( new EmpalizadaEscaleraNorteDeed() );
					}
					else if ( item is EmpalizadaNorteAddon )
					{
						from.AddToBackpack( new EmpalizadaNorteDeed() );
					}
					else if ( item is EmpalizadaPuertaNAddon )
					{
						from.AddToBackpack( new EmpalizadaPuertaNDeed() );
					}
					else if ( item is EmpalizadaTorreEsquineraAddon )
					{
						from.AddToBackpack( new EmpalizadaTorreEsquineraDeed() );
					}
					else if ( item is EmpalizadaEscaleraWestAddon )
					{
						from.AddToBackpack( new EmpalizadaEscaleraWestDeed() );
					}
					else if ( item is EmpalizadaWestAddon )
					{
						from.AddToBackpack( new EmpalizadaWestDeed() );
					}
					else if ( item is EmpalizadaEscaleraEstAddon )
					{
						from.AddToBackpack( new EmpalizadaEscaleraEstDeed() );
					}
					else if ( item is EmpalizadaEstAddon )
					{
						from.AddToBackpack( new EmpalizadaEstDeed() );
					}
					else if ( item is EmpalizadaEscaleraSurAddon )
					{
						from.AddToBackpack( new EmpalizadaEscaleraSurDeed() );
					}
					else if ( item is EmpalizadaSurAddon )
					{
						from.AddToBackpack( new EmpalizadaSurDeed() );
					}
					else if ( item is EmpalizadaPuertaEstAddon )
					{
						from.AddToBackpack( new EmpalizadaPuertaEstDeed() );
					}
					else if ( item is EmpalizadaPuertaWestAddon )
					{
						from.AddToBackpack( new EmpalizadaPuertaWestDeed() );
					}
					else if ( item is EmpalizadaPuertaSurAddon )
					{
						from.AddToBackpack( new EmpalizadaPuertaSurDeed() );
					}
				...
				else if ( m_Sign.Type == CivicSignType.Moongate )
				{
					m_Sign.Stone.HasMoongate = false;
                                ...
                                else if ( m_Sign.Type == CivicSignType.Barracks )
				{
                                        if ( m_Sign.Stone.Barracks.Contains( this ) )
						m_Sign.Stone.Barracks.Remove( this );
				}
