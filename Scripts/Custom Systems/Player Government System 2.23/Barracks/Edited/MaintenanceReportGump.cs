...
namespace Server.Gumps
{
	public class MaintenanceReportGump : Gump
	{
		...
		public MaintenanceReportGump( CityManagementStone stone ) : base( 50, 50 )
		{
			...
			int hallCost = 100 /* m_Stone.Level*/;

			cost += hallCost;

			int citizensCost = m_Stone.Citizens.Count ;
			cost += citizensCost;

			int decoreCost = m_Stone.CurrentDecore ;
			cost += decoreCost;
int addoncost = m_Stone.AddOns.Count * 100;
       ...
       int barrackCost = m_Stone.Barracks.Count * 1000;
			cost += barrackCost;
   
			int gardenCost = m_Stone.Gardens.Count * 10;
			cost += gardenCost;
			
			int parkCost = m_Stone.Parks.Count * 100;
			cost += parkCost;
			...
			AddBackground(30, 29, 289, 382/*319*/, 5120);
			...
			if ( m_Stone.HasBank == true )	
				AddLabel(45, 125, 1149, @"Bank Cost: 100");
			else
				AddLabel(45, 125, 1149, @"Bank Cost: 0");

			if ( m_Stone.HasHealer == true )
				AddLabel(45, 145, 1149, @"Healer Cost: 100");
			else
				AddLabel(45, 145, 1149, @"Healer Cost: 0");

			if ( m_Stone.HasTavern == true )
				AddLabel(45, 165, 1149, @"Tavern Cost: 100");
			else
				AddLabel(45, 165, 1149, @"Tavern Cost: 0");

			if ( m_Stone.HasMoongate == true )
				AddLabel(45, 185, 1149, @"Moongate Cost: 100");
			else
				AddLabel(45, 185, 1149, @"Moongate Cost: 0");

			if ( m_Stone.HasStable == true )
				AddLabel(45, 205, 1149, @"Stable Cost: 100");
			else
				AddLabel(45, 205, 1149, @"Stable Cost: 0");

			if ( m_Stone.IsGuarded == true )
				AddLabel(45, 225, 1149, @"Guards Cost: 100" );
			else
				AddLabel(45, 225, 1149, @"Guards Cost: 0" );

			if ( m_Stone.IsRegistered == true )
				AddLabel(45, 245, 1149, @"Registration Cost: 100");
			else
				AddLabel(45, 245, 1149, @"Registration Cost: 0");
    
            AddLabel(45, 285/*265*/, 1149, @"Barracks Cost: " + barrackCost.ToString() );
    
			AddLabel(45, 265/*265*/, 1149, @"Gardens Cost: " + gardenCost.ToString() );
    
			AddLabel(45, 305/*285*/, 1149, @"Parks Cost: " + parkCost.ToString() );
            AddLabel( 45, 325, 1149, @"AddOn Cost: " + addoncost.ToString() );	
			
			if ( m_Stone.HasMarket )
				AddLabel( 45, 345, 1149, @"Market Cost: 1000");
			else
				AddLabel( 45, 345, 1149, @"Market Cost: 0");

			AddImageTiled(35, 351/*311*/, 280, 10, 5121);

			AddLabel(45, 358/*318*/, 1149, @"Total Maintenance: " + cost.ToString() );
		}
