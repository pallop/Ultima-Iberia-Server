	...
	{ 
		...
		{ 
			...
			{ 
				...
				Add( new GenericBuyInfo( "Barracks Deed", typeof( BarracksAddonDeed ), 20000, 10, 0x14F0, 0 ) );
                ...
                //Add( new GenericBuyInfo( "City Graniery Storage Barrel", typeof(GraneryBarrel), 1000, 10, 0x14F0, 0));
			} 
		} 
