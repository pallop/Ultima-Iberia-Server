...
namespace Server.Customs.Invasion_System
{
    public class TownInvasion
    {
        ...
        private InvasionTowns _InvasionTown = InvasionTowns.Navarra;
        ...
        public void CheckSpawn()
        {
            ...
            {
                string message = String.Format("{0} Esta siendo Invadida {1}. VE A AYUDARLES!", TownInvaded, TownMonsterType);
