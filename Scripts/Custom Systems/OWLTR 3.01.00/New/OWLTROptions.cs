...
namespace daat99
{
	public class OWLTROptionsManager
	{
		...
		public enum OPTIONS_ENUM
		{
			...
			MULE_FORGE, CRAFT_RUNIC_JEWELERY, USE_STORAGE_RESOURCES, MONSTER_GIVE_TOKENS, BOD_GIVE_TOKENS,
		...
		public void InitOwltrOptions()
		{
			...
			AddOption(OPTIONS_ENUM.CRAFT_RUNIC_JEWELERY, new OWLTROption("Craft Runic Jewlery", "Enabling Craft Runic Jewlery will enable players to craft runic jewlery (rings, bracelets, earings) with runic tinker tools.", true));
			...
			AddOption(OPTIONS_ENUM.BOD_GIVE_TOKENS, new OWLTROption("Bod Give Tokens", "Enabling Bod Give Tokens add tokens to players token ledger (assuming they have one that belong to them in their pack) when they return a full bod to the apropriate vendor.", true));
