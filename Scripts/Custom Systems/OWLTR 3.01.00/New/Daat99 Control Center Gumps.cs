...
namespace daat99
{
	public class Daat99CustomOWLTRGump : Gump 
	{
		...
		public Daat99CustomOWLTRGump( PlayerMobile from ) : base( 100, 100 ) 
		{
			...
			AddLabel( 35, 198, 70, @"MuleForge\RunicJewls\RegsKeys" );
			...
			///DO NOT CHANGE THESE LINES
			///DO NOT CHANGE THESE LINES
			AddHtml(260, 65, 285, 40, String.Format("<basefont color=#00ff00>I like to say special Thanks for a huge assistance in testing efforts to:</font>"), false, false);
			///DO NOT CHANGE THESE LINES
			///DO NOT CHANGE THESE LINES
			...
			///DO NOT CHANGE THESE LINES
			///DO NOT CHANGE THESE LINES
			AddHtml(260, 145, 285, 40, String.Format("<basefont color=#ff0000>I like to say Thanks to my fellow RunUO members:</font>"), false, false);
			///DO NOT CHANGE THESE LINES
			///DO NOT CHANGE THESE LINES
			...
			//Runic Jewlery 
			OWLTROptionsManager.GetOption(OWLTROptionsManager.OPTIONS_ENUM.CRAFT_RUNIC_JEWELERY).AddToGump(this, 260, 175, b_ForStaff, OPTIONS_DIFF + (int)OWLTROptionsManager.OPTIONS_ENUM.CRAFT_RUNIC_JEWELERY, true); 
