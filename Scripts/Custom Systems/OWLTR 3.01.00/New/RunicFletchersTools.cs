		...
		public override Type GetCraftableType()
		{
			switch (Resource)
			{
				...
				/*case CraftResource.Agapite:
					return typeof(AgapiteFletcherTools);
				case CraftResource.Bronze:
					return typeof(BronzeFletcherTools);
				case CraftResource.Copper:
					return typeof(CopperFletcherTools);
				case CraftResource.DullCopper:
					return typeof(DullCopperFletcherTools);
				case CraftResource.Gold:
					return typeof(GoldFletcherTools);
				case CraftResource.ShadowIron:
					return typeof(ShadowIronFletcherTools);
				case CraftResource.Valorite:
					return typeof(ValoriteFletcherTools);
				case CraftResource.Verite:
					return typeof(VeriteFletcherTools);*/
				default:
					return null;
			}
		}
