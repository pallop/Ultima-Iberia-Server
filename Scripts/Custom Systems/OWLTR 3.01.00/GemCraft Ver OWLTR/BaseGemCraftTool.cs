...
{
	public abstract class BaseGemCraftTool : BaseTool
	{
		...
		public BaseGemCraftTool( CraftResource resource, int itemID ) : base( itemID )
		{
			m_Resource = resource;
		}

		public BaseGemCraftTool( CraftResource resource, int uses, int itemID ) : base( uses, itemID )
		{
			m_Resource = resource;
		}

		public BaseGemCraftTool( Serial serial ) : base( serial )
		{
		}
		...
		public static void ApplyAttributesTo( BaseWeapon weapon, bool isGemCraftTool, int luckChance, int attributeCount, int min, int max )
		{
		...
		public static void ApplyAttributesTo( BaseHat hat, bool isGemCraftTool, int luckChance, int attributeCount, int min, int max )
		{
			m_LuckChance = luckChance;
		...
		public static void ApplyAttributesTo( BaseJewel jewelry, bool isGemCraftTool, int luckChance, int attributeCount, int min, int max )
		{
			m_LuckChance = luckChance;
		...
		public static void ApplyAttributesTo( Spellbook spellbook, bool isGemCraftTool, int luckChance, int attributeCount, int min, int max )
		{
			m_LuckChance = luckChance;
