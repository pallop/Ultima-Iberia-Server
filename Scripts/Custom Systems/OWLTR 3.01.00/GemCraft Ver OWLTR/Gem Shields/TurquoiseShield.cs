...
{
    public class TurquoiseShield : BaseShield
    {
        ...
        [Constructable]
        public TurquoiseShield() : base(7108)
        {
            Weight = 6.0;
            Hue = 1366;
            Name = "Turquoise Shield";

            Attributes.DefendChance = Utility.RandomMinMax(4, 11);
        ...
        public TurquoiseShield(Serial serial)
            : base(serial)
        {
        }
