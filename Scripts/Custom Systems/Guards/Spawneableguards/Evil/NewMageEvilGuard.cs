...
namespace Server.Mobiles
{
    ...
    public class NewMageEvilGuard : BaseEvilGuard
    {
        private DateTime m_NextCastTime;
        [Constructable]
        public NewMageEvilGuard()
            : base(AIType.AI_Mage)
        {
            SetStr(40, 100);
            SetDex(26, 60);
            ...
            AddItem(new Robe(0x484));
            AddItem(new Sandals(0x484));
            AddItem(new WizardsHat(0x484));
	...
	public override bool OnBeforeDeath()
	{
        ...
        public NewMageEvilGuard(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void OnGotMeleeAttack(Mobile d)
        {
            if (0.2 >= Utility.RandomDouble())
                this.Say("Tendras que hacerlo mucho mejor.");
