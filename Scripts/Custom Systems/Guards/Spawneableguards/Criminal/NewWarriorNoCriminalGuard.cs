...
namespace Server.Mobiles
{
    ...
    public class NewWarriorNoCriminalGuard : BaseAntiCriminal
    {
        [Constructable]
	...
	public override bool OnBeforeDeath()
	{
        ...
        public NewWarriorNoCriminalGuard(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void OnDamagedBySpell(Mobile d)
        {
            ...
            {
                this.Say("Your spells will not help you.");
            }
            if (this.Hits < this.HitsMax / 2)
            {
                if (BandageContext.GetContext(this) == null)
