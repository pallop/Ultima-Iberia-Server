...
{ 
    public class BaseAntiCriminal : BaseCreature 
    {
        public override bool BardImmune{ get{ return true; } } 
        public virtual bool AdvancedGuardsCommand{ get{ return true; } }

        public BaseAntiCriminal(AIType aiType)
        ...
        public override void OnMovement(Mobile m, Point3D oldLocation)
        {
            if (base.Combatant == null)
            {
                ...
                {
                    if (base.CanSee(m) && !(m.Hidden) && m.AccessLevel == AccessLevel.Player)
                    {
                        base.Combatant = m;
                        base.Warmode = true;
                    }
        ...
        public BaseAntiCriminal(Serial serial)
            : base(serial) 
        { 
        }
