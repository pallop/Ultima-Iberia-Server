...
{ 
    public class BaseGuardiaSegovia : BaseCreature 
    {
        public override bool BardImmune{ get{ return true; } } 
        public virtual bool AdvancedGuardsCommand{ get{ return true; } }

        public BaseGuardiaSegovia(AIType aiType)
        ...
        public override void OnMovement(Mobile m, Point3D oldLocation)
        {
            ...
            if (base.Combatant == null)
            {
                ...
                {
                    if (base.CanSee(m) && (m is BaseGuardiaLisboa) && (m is BaseGuardiaValencia) || !(m.Hidden) && (m.Criminal) && m.AccessLevel == AccessLevel.Player || (m is PlayerMobile && pm.CrimiValencia == true))
                    {
                        base.Combatant = m;
                        base.Warmode = true;
                    }
        ...
        public BaseGuardiaSegovia(Serial serial)
            : base(serial) 
        { 
        }
