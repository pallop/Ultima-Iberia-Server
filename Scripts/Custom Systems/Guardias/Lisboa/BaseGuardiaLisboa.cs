...
{ 
    public class BaseGuardiaLisboa : BaseCreature 
    {
        public override bool BardImmune{ get{ return true; } } 
        public virtual bool AdvancedGuardsCommand{ get{ return true; } }

        public BaseGuardiaLisboa(AIType aiType)
        ...
        public override void OnMovement(Mobile m, Point3D oldLocation)
        {
            ...
            if (base.Combatant == null)
            {
                ...
                {
                    if (base.CanSee(m) && (m is BaseGuardiaNavarra) && (m is BaseGuardiaSegovia) || !(m.Hidden) && (m.Criminal) && m.AccessLevel == AccessLevel.Player || (m is PlayerMobile && pm.CrimiLisboa == true))
                    {
                        base.Combatant = m;
                        base.Warmode = true;
                    }
        ...
        public BaseGuardiaLisboa(Serial serial)
            : base(serial) 
        { 
        }
