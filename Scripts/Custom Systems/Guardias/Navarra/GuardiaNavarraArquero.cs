...
namespace Server.Mobiles
{
    ...
    public class GuardiaNavarraArquero : BaseGuardiaNavarra
    {
    private int currentweapon;

        [Constructable]
        public GuardiaNavarraArquero()
            : base(AIType.AI_Archer)
        {
			...
			AddItem(new Boots(1149));
            AddItem(new Cloak(1149));
			PackItem(new Dagger());
	...
	public override bool OnBeforeDeath()
	{
        ...
        public GuardiaNavarraArquero(Serial serial)
            : base(serial)
        {
        }
