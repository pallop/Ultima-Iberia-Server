        ...
        public override void OnThink()
        {
            ...
            if (NextCallout == TimeSpan.Zero)
            {
                ...
                if(Hits < (HitsMax * 0.33) && Combatant != null)
                {
                    ...
                    {
                        case 1: Say("Necesito un poco de espacio."); break;
                        case 2: Say("No creo que lo vaya a hacer.."); break;
                        case 3: Say("Voy a echar un ojo..."); break;
                        case 4: Say("No puedo hacerlo solo."); break;
                        case 5: Say("VALHALLAAAAAA."); break;
                        default: break;
                    }
                        ...
                        if(m is Guard && m.Hits > (m.HitsMax * 0.33) && m != this)
                        {
                            if (Combatant != null && Combatant != m.Combatant)
                            {
                                ...
                                {                                
                                    ...
                                    {
                                        case 1: m.Say("Estoy de camino."); break;
                                        case 2: m.Say("Estas cerca {0}, Te tengo!.", Name); break;
                                        case 3: m.Say("No me obligues a hacerlo..."); break;
                                        case 4: m.Say("Aguanta! {0} ya llego!.", Name); break;
                                        default: break;
                                    }
                                }
