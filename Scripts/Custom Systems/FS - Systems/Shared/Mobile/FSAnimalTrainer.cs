...
{
    public class FSAnimalTrainer : BaseVendor
    {
        ...
        [Constructable]
        public FSAnimalTrainer() : base("the animal trainer")
        {
        ...
        {
            this.m_SBInfos.Add(new SBFSAnimalTrainer());
        }
        ...
        private class TamingBulkOrderInfoEntry : ContextMenuEntry
		{
			...
			private readonly FSAnimalTrainer m_Vendor;

			public TamingBulkOrderInfoEntry(Mobile from, FSAnimalTrainer vendor)
				: base(6152)
			{
				this.m_From = from;
        ...
        {
            private readonly FSAnimalTrainer m_Trainer;
            private readonly Mobile m_From;

            public StableEntry(FSAnimalTrainer trainer, Mobile from) : base(6126, 12)
            {
        ...
        private class ClaimListGump : Gump
        {
            ...
            public ClaimListGump(FSAnimalTrainer trainer, Mobile from, List<BaseCreature> list)
                : base(50, 50)
            {
                this.m_Trainer = trainer;
                this.m_From = from;
        ...
        private class ClaimAllEntry : ContextMenuEntry
        {
            ...
            public ClaimAllEntry(FSAnimalTrainer trainer, Mobile from)
                : base(6127, 12)
            {
                this.m_Trainer = trainer;
                this.m_From = from;
        ...
        private class StableTarget : Target
        {
            ...
            public StableTarget(FSAnimalTrainer trainer)
        ...
        public FSAnimalTrainer(Serial serial)
            : base(serial)
        {
        }
