...
namespace Server.Engines.Build
{
	...
	public class BuildContext
	{
		...
		private BuildMarkOption m_MarkOption;
		...
		public BuildMarkOption MarkOption{ get{ return m_MarkOption; } set{ m_MarkOption = value; } }
		...
		public BuildItem LastMade
		{
			get
			{
				if ( m_Items.Count > 0 )
					return (BuildItem)m_Items[0];

				return null;
			}
		}

		public void OnMade( BuildItem item )
		{
			m_Items.Remove( item );
