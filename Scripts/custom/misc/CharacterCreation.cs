...
namespace Server.Misc
{
    public class CharacterCreation
    {
        ...
        public static readonly CityInfo StartingCity = new CityInfo("Iberia", "Iberia", 5300,    1191,   0, Map.Felucca);
        ...
        private static void AddBackpack(Mobile m)
        {
            ...
            PackItem(new Candle());
            PackItem(new Apple(30));
            PackItem(new Pitcher( BeverageType.Water ));
            PackItem(new Pitcher( BeverageType.Water ));
            PackItem(new Pitcher( BeverageType.Water ));
            PackItem(new Pitcher( BeverageType.Water ));
            PackItem(new Pitcher( BeverageType.Water ));
            PackItem(new HoodableRobe());
            //PackItem(new SkillBallPlus());
            PackItem(new LokaiSkillBall());
            PackItem(new LokaiSkillBall());
            PackItem(new AgeChangeDeed());
...
newChar.StatCap = 225;
        ...
        private static CityInfo GetStartLocation(CharacterCreatedEventArgs args, bool isYoung)
        {
            if (Core.ML)
            {
                ...
                return StartingCity;	//We don't get the client Version until AFTER Character creation
