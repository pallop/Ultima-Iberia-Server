...
namespace Server.Misc
{
    public class DataPath
    {
        ...
        */
       // private static string CustomPath = null ; //UltimaLive
    private static string CustomPath = @"E:/Ultima Online/Ultimaiberia/clientfiles";
        //private static readonly string CustomPath = @"E:/Ultima Online/Ultimaiberia";
