    ...
    public class DefBlacksmithy : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            */
            ...
            //skills nuevas
            this.AddCraft(typeof(ButchersCleaver), "items skills", "Butchers Cleaver", 24.3, 74.3, typeof(IronIngot), 1044036, 8, 1044037);
            this.AddCraft(typeof(PilferingGloves), "items skills", "Pilfering Gloves", 24.3, 74.3, typeof(IronIngot), 1044036, 8, 1044037);
            this.AddCraft(typeof(SkinningDagger), "items skills", "Skinning Dagger", 24.3, 74.3, typeof(IronIngot), 1044036, 8, 1044037);
            this.AddCraft(typeof(VentriloquistsGorget), "items skills", "Ventriloquists Gorget", 24.3, 74.3, typeof(IronIngot), 1044036, 8, 1044037);
