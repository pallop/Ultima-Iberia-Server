...
namespace Server.Engines.Craft
{
    ...
    public class DefTinkering : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
			...
			this.AddCraft( typeof( LumberjacksAxe ), 1044046, "Lumberjack's Axe", 40.0, 90.0, typeof( IronIngot ), 1044036, 4, 1044037); //daat99 OWLTR - lumberjacks axe by Hammerhand
            ...
            this.AddCraft( typeof( ArchitectTool ), "Utiles construccion", "architect tool", 25.0, 75.0, typeof( IronIngot ), "Iron Ingot", 5 );
            this.AddCraft( typeof( BrickLayersTool ), "Utiles construccion", "BrickLaying tool", 25.0, 75.0, typeof( IronIngot ), "Iron Ingot", 5 );
            this.AddCraft( typeof( WoodworkersTool ), "Utiles construccion", "Woodworkers tool", 25.0, 75.0, typeof( IronIngot ), "Iron Ingot", 5 );
            this.AddCraft( typeof( FramingTool ), "Utiles construccion", "Framing tool", 25.0, 75.0, typeof( IronIngot ), "Iron Ingot", 5 );
            this.AddCraft( typeof( RoofersTool ), "Utiles construccion", "Roofers tool", 25.0, 75.0, typeof( IronIngot ), "Iron Ingot", 5 );
            this.AddCraft( typeof( StoneMasonsTool ), "Utiles construccion", "StoneMasons tool", 25.0, 75.0, typeof( IronIngot ), "Iron Ingot", 5 );
            this.AddCraft( typeof( TreeHarvestTool ), "Utiles construccion", "Tree Harvest", 25.0, 75.0, typeof(Log), 1044041, 9, 1044351);

            //Supplies Lokaiskills
            this.AddCraft( typeof( MortarSupply ), "recursos construccion", "Mortar Supply", 25.0, 75.0, typeof( IronIngot ), "Iron Ingot", 5 );
            this.AddCraft( typeof( HingeSupply ), "recursos construccion", "Hinge Supply", 25.0, 75.0, typeof( IronIngot ), "Iron Ingot", 5 );
            this.AddCraft( typeof( PaintSupply ), "recursos construccion", "Paint Supply", 25.0, 75.0, typeof( IronIngot ), "Iron Ingot", 5 );
            this.AddCraft( typeof( StainSupply ), "recursos construccion", "Stain Supply", 25.0, 75.0, typeof( IronIngot ), "Iron Ingot", 5 );
            this.AddCraft( typeof( NailSupply ), "recursos construccion", "Nail Supply", 25.0, 75.0, typeof( IronIngot ), "Iron Ingot", 5 );
            this.AddCraft( typeof( CementSupply ), "recursos construccion", "Cement Supply", 25.0, 75.0, typeof( IronIngot ), "Iron Ingot", 5 );
            this.AddCraft( typeof( TarSupply ), "recursos construccion", "Tar Supply", 25.0, 75.0, typeof( IronIngot ), "Iron Ingot", 5 );
            this.AddCraft( typeof( PitchSupply ), "recursos construccion", "Pitch Supply", 25.0, 75.0, typeof( IronIngot ), "Iron Ingot", 5 );
...
#region Customs
			...
			//BankHive == Item class (when you use [add BankHive) need to be case sensitive.
			//"customs" == the category the item will be listed in
			//"Bank Hive" == The name the player will see in the craft gump
			//100.0 == minimum skill needed to try to craft.
			//AddRes == add new resource requirements to craft the item
			//typeof( PlatinumIngot ) == Make the resource PlatinumIngot (just like how you type [add PlatinumIngot) need to be case sensitive.
			//"Platinum Ingots" == The name of the resource that the player will see in the resource needed gump
			//100 == the amount of PlatinumIngot the player need in pack to craft the item
			//"You need more Platinum Ingots" == the messagee the player will get if he don't have enough PlatinumIngot in his backpack.
			*/
