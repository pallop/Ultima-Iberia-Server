...
private static Type[] m_TailorNonColorables = new Type[]
       ...
       private static Type[] m_TailorColorables = new Type[]
        ...
        public override void InitCraftList()
        {
            ...
            this.AddCraft(typeof(FurSleeper_EDeed), 1015283, 1025437, 29.0, 54.0, typeof(Leather), 1044462, 28, 1044463);
            this.AddCraft(typeof(FurSleeper_SDeed), 1015283, 1025437, 29.0, 54.0, typeof(Leather), 1044462, 28, 1044463);
            ...
            this.AddCraft(typeof(RidingCape), "Item skills", "Riding Cape", 70.5, 95.5, typeof(Leather), 1044462, 12, 1044463);
