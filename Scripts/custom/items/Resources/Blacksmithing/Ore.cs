...
namespace Server.Items
{
	...
	{
		[Constructable]
		public BlazeOre() : this( 1 )
		{
		}
		[Constructable]
		public BlazeOre( int amount ) : base( CraftResource.Blaze, amount )
		{
			Name = "Blaze Ore"; //daat99 OWLTR - custom resource name
		}
		public BlazeOre( Serial serial ) : base( serial )
        {
        }
	...
	public class ToxicOre : BaseOre
    {
        ...
        [Constructable]
		public ToxicOre() : this( 1 )
        {
        }

        [Constructable]
		public ToxicOre( int amount ) : base( CraftResource.Toxic, amount )
        {
			Name = "Toxic Ore"; //daat99 OWLTR - custom resource name
        }

		public ToxicOre( Serial serial ) : base( serial )
        {
        }
