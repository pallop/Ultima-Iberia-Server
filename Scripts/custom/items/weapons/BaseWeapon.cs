...
namespace Server.Items
{
	...
	public abstract class BaseWeapon : WearableItem, IWeapon, IFactionItem, ICraftable, ISlayer, IDurability, ISetItem
	{
        ...
        */
		...
		public override bool CanEquip(Mobile from)
		{
			...
			if (RequiredRace != null && from.Race != RequiredRace)
			{
				...
				{
					//from.SendLocalizedMessage("Humanos"); // Only Elves may use this.
				}
					#region SA
