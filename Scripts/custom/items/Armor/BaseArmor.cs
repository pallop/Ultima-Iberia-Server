                ...
                if (item is BaseArmor)
                {
                    ...
                    if (armor.RequiredRace != null && m.Race != armor.RequiredRace)
                    {
                        ...
                        if (armor.RequiredRace == Race.Elf);
                         //   m.SendLocalizedMessage("Humanos"); // Only Elves may use this.
                ...
                case 0:
                    {
                        ...
                        if (this.m_Resource == CraftResource.None)
                        {
							...
							//daat99 OWLTR start - add custom leather
								...
								this.m_Resource = CraftResource.PolarLeather;
							else if ( mat == ArmorMaterialType.Synthetic )
								this.m_Resource = CraftResource.SyntheticLeather;
							else if ( mat == ArmorMaterialType.BlazeL )
								this.m_Resource = CraftResource.BlazeLeather;
							else if ( mat == ArmorMaterialType.Daemonic )
								this.m_Resource = CraftResource.DaemonicLeather;
							else if ( mat == ArmorMaterialType.Shadow )
								this.m_Resource = CraftResource.ShadowLeather;
							else if ( mat == ArmorMaterialType.Frost )
								this.m_Resource = CraftResource.FrostLeather;
							else if ( mat == ArmorMaterialType.Ethereal )
								this.m_Resource = CraftResource.EtherealLeather;
							//daat99 OWLTR end
                            else
