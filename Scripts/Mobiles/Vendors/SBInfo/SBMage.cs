    ...
    public class SBMage : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            public InternalBuyInfo()
            {
                ...
                this.Add(new GenericBuyInfo(typeof(BardSpellbook), 115, 10, 0xEFA, 0));
                    this.Add(new GenericBuyInfo(typeof(ClericSpellbook), 115, 10, 0xEFA, 0));
                    this.Add(new GenericBuyInfo(typeof(DruidSpellbook), 115, 10, 0xEFA, 0));
                    this.Add(new GenericBuyInfo(typeof(RangerSpellbook), 115, 10, 0xEFA, 0));
                ...
                this.Add(new GenericBuyInfo(typeof(DestroyingAngel), 3, 20, 0XE1F, 0 ));
                this.Add(new GenericBuyInfo(typeof(PetrafiedWood),3, 20, 0x97A, 0 ));
                this.Add(new GenericBuyInfo(typeof(SpringWater),3, 20, 0xE24, 0 ));
