    ...
    public class SBTailor : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            public InternalBuyInfo()
            {
                ...
                this.Add(new GenericBuyInfo(typeof(RawCotton), 102, 20, 0xDF9, 0));
                this.Add(new GenericBuyInfo(typeof(RawWool), 62, 20, 0xDF8, 0));
                this.Add(new GenericBuyInfo(typeof(RawFlax), 102, 20, 0x1A9C, 0));
