    ...
    public class SBAlchemist : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            ...
            { 
                ...
                this.Add( new GenericBuyInfo( typeof( BottledLightning ), 100, 3, 0xF0E, 0 ) );
                this.Add( new GenericBuyInfo( typeof( CrystalisedEnergy ), 100, 5, 0x2AAA, 0 ) );
                this.Add( new GenericBuyInfo( typeof( DryIce ), 100, 3, 0xF8F, 0 ) );
                this.Add( new GenericBuyInfo( typeof( GazerEye ), 100, 3, 0xF0E, 0 ) );
                this.Add( new GenericBuyInfo( typeof( GiantSpiderVenom ), 25, 5, 0xF8E, 0 ) );

              

                this.Add( new GenericBuyInfo( typeof( HeatingStand ), 2, 100, 0x1849, 0 ) ); // This is on OSI :-P
            }
        }
