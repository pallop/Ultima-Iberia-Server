...
#else
				parms.CompilerOptions = String.Format( "{0} /nowarn:169,219,414 /recurse:Scripts/*.cs", parms.CompilerOptions );  //original
				
				//parms.CompilerOptions = String.Format( "{0} /nowarn:169,219,109,414 /recurse:Scripts/*.cs", parms.CompilerOptions )
